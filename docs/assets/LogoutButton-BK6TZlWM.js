import{s as c}from"./supabase-UP22jYpv.js";class n{constructor(t="/"){this.redirectTo=t}render(){const t=document.createElement("button");return t.className="logout-button",t.innerHTML=this.icon(),t.addEventListener("click",async()=>{await c.auth.signOut(),window.location.replace(this.redirectTo)}),t}icon(){return`
